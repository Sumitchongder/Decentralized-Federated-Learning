...
def load_mnist(num_clients=2, batch_size=32):
    ...
    test_loader = DataLoader(datasets.MNIST(root="./data", train=False, download=True, transform=transform), batch_size=batch_size)
